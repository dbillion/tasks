export const VENUE_STATIC_HELSINKI = {
  "venue": {
...
export const VENUE_STATIC_TALLINN = 
{
  "venue": {
    "id": "677fb1a8ebfdaa6f4a597114",
    "image_url": "https://image-resizer-proxy.development.dev.woltapi.com/assets/677fb1ad2e9a6361713418d3",
    "image_blurhash": "j2jQRa00hGTt;;gPmXKWcPTsPbpl",
    "brand_logo_image_url": null,
    "brand_logo_image_blurhash": null,
    "brand_slug": null,
    "brand_name": null,
    "name": "Home Assignment Venue Tallinn",
    "description": "This is a venue that's used in engineering home assignment. Please don't modify!",
    "rating": null,
    "opening_times_schedule": [
      {
    ...
    "group_order_enabled": true,
    "share_url": "https://wolt-com.development.dev.woltapi.com/et/est/tallinn/restaurant/home-assignment-venue-tallinn",
    "delivery_methods": [
      "takeaway",
      "homedelivery"
    ],
    ...
    "delivery_geo_range": {
      ...
      "coordinates": [
        [
          [24.4961785848032, 59.3149093896844],
          [24.5503234863281, 59.3835836795363],
          [24.5173645019531, 59.529443625542],
          [24.7412109375, 59.6031801525984],
          [24.9348449707031, 59.5496328786887],
          [24.9623107910156, 59.3562960806732],
          [24.7412109375, 59.2904357203873],
          [24.5017208944237, 59.3114925148841],
          [24.4961785848032, 59.3149093896844]
        ]
      ]
    },
    ...
    "show_delivery_preestimate_by_time": false,
    "merchant": {
      "id": "677fa888bce88da782cde75e",
      "name": "Home Assignment Merchant Estonia",
      "business_id": "123456",
      "street_address": "Aia 10a",
      "city": "Tallinn",
      "post_code": "10111",
      "country": "Estonia"
    },
    "digital_services_act_information": {
      "name": "Home Assignment Merchant Estonia",
      "business_id": "123456",
      "address": "Aia 10a, 10111, Tallinn, Estonia",
      "self_certification": "The Partner is committed to only offering products and/or services that comply with the applicable laws.",
      "report_item_url": "https://www.surveymonkey.com/r/VHFTCJX"
    },
    "slug": "home-assignment-venue-tallinn",
    "venue_supports_wolt_pay": false,
    "group_order_id": null,
    "info": {
      "venue_info_service_fee_description": null,
  ...
  "venue_raw": {
    ...
    "comment_disabled": false,
    "short_description": null,
    "city_id": "58a46408e1baa06a01c29653",
    "merchant": "677fa888bce88da782cde75e",
    "show_allergy_disclaimer_on_menu": false,
    "price_range": 0,
    "item_cards_enabled": false,
    "service_fee_description": "Helps us improve our delivery service further by bringing you new features to enjoy and providing exceptional customer support. The service fee may vary based on order value, selected venue, or delivery method.",
    ...
    "location": {
      "bbox": null,
      "type": "Point",
      "coordinates": [24.7513679, 59.4385937]
    },
    "string_overrides": null
  },
  "order_minimum": 1000
};

export const VENUE_DYNAMIC_HELSINKI = {
  "venue": {
    "delivery_open_status": {
      ...
      "is_open": true,
      "now": "2025-01-14T12:43:07.210956+02:00",
      "previous_open": null,
      "next_open": null,
      "next_close": null,
  ...
  "venue_raw": {
    ...
    "discounts_restrictions_text": "The following categories are excluded from offers: beer, wine, alcohol, tobacco, nicotine products, smokers items and accessories, medicine, baby formula, newspaper, magazines and lottery scratchcards",
    "preorder_specs": {
      "preorder_only": false,
      "time_step": 5,
      "homedelivery_spec": {
...
export const VENUE_DYNAMIC_TALLINN = {
  "venue": {
    "delivery_open_status": {
      "value": "Open all day",
      "style": {
      ...
      "is_open": true,
      "now": "2025-01-14T12:43:09.246753+02:00",
      "previous_open": null,
      "next_open": null,
      "next_close": null,
      "next_close_time_localized": null
  ...
  "venue_raw": {
    ...
    "self_delivery": false,
    "payment_method_restrictions": null,
    "discounts_restrictions_text": "The following categories are excluded from offers: beer, wine, alcohol, tobacco, nicotine products, smokers items and accessories, medicine, baby formula and lottery scratchcards",
    "preorder_specs": {
      "preorder_only": false,
      "time_step": 5,
      "homedelivery_spec": {
